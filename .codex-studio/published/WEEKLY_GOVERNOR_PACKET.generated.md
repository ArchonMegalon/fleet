...
- Launch gate pass count: 7
- Launch gate blocked count: 7
- Launch gate fail count: 2
- Launch gate blocking names: package_authority, source_input_health, successor_dependencies, flagship_readiness, flagship_quality, status_plane_final_claim, journey_gates, local_release_proof, provider_canary
- Freeze active: True
- Canary ready: False
...
- Weekly adoption state: early
- Weekly adoption history snapshots: 15
- Weekly adoption proven journeys: 0
- Weekly adoption proven routes: 0
...
| --- | --- | --- | --- | --- | --- | --- |
| launch_expand | blocked | weekly_governor_packet.launch_expand | do_not_expand_launch | m106-launch_expand-f5f5c0323c2cbdb0 | package_authority, source_input_health, successor_dependencies, flagship_readiness, flagship_quality, status_plane_final_claim, journey_gates, local_release_proof, provider_canary | Hold expansion until successor dependencies, readiness, parity, localization/accessibility quality, status-plane final claim, local release proof, canary, closure, and support gates are all green. |
