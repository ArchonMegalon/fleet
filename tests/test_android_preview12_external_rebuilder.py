...
def test_checked_in_builder_public_binding_is_current_without_credential_activation() -> None:
    ...
    assert lock["android_authority"]["commit"] == "0d5c8f0cacfdfbb89288eb0f3906d2fdbab36d0a"
    assert lock["android_authority"]["tree"] == "7d2585c46236f975a7a4d73a591688fd84b4228f"
