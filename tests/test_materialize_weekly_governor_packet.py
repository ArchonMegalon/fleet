...
def test_materialize_weekly_governor_packet_freezes_when_canary_and_release_proof_are_not_green(tmp_path: Path) -> None:
    ...
    assert payload["package_verification"]["local_proof_floor_commits"] == ["065c653", "fb47ce8"]
    ...
    assert payload["repeat_prevention"]["local_proof_floor_commits"] == ["065c653", "fb47ce8"]
    ...
    assert "- Local proof floor commits: 065c653, fb47ce8" in markdown
