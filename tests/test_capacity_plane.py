...
class CapacityPlaneTests(unittest.TestCase):
    ...
    def test_build_capacity_plan_uses_nested_pool_safety_caps_when_project_cap_is_not_explicit(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
                "max_scale_up_per_tick": 20,
                "ramp": {"ready_reserve_step_divisor": 1},
            },
            "booster_pools": {
                "core_booster": {
                    "worker_lane": "core_booster",
            ...
            "review_fabric": {"default": {"shards": {"lane": "review_shard", "service_floor": 1, "max_queue_depth_per_active_reviewer": 4}}},
            "audit_fabric": {"default": {"service_floor": 1, "target_parallelism": 4}},
        }
        status = {
            "config": {
                "policies": {
            ...
            "work_packages": {"ready_packages": 20, "ready_scope_cap": 20, "scope_cap": 20, "active_packages": 0},
            "cockpit": {
                ...
                "mission_board": {
                    ...
                    "provider_credit_card": {
                        ...
                        "hours_remaining_at_current_pace_no_topup": 10,
                    },
                },
                "capacity_forecast": {
                    "lanes": [
    ...
    def test_build_capacity_plan_uses_booster_pool_defaults_when_status_only_carries_pool_name(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
                "max_scale_up_per_tick": 20,
    ...
    def test_build_capacity_plan_raises_authority_target_when_ready_package_reserve_is_starved(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
        ...
        status = {
            ...
            "cockpit": {
                "summary": {"active_review_workers": 4, "queued_jury_jobs": 0, "open_incidents": 0},
                "mission_board": {
                    "booster_runtime_card": {"active_onemin_codexers": 1, "active_boosters": 1},
                    "provider_credit_card": {
    ...
    def test_build_capacity_plan_caps_boosters_to_survive_until_inferred_topup(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
                "credit": {"reserve_buffer_hours": 6, "cycle_reserve_percent": 0},
                "max_scale_up_per_tick": 20,
                "ramp": {"ready_reserve_step_divisor": 1},
            },
            "booster_pools": {
            ...
            "review_fabric": {"default": {"shards": {"lane": "review_shard", "service_floor": 20, "max_queue_depth_per_active_reviewer": 8}}},
            "audit_fabric": {"default": {"service_floor": 1, "target_parallelism": 20}},
        }
        status = {
            "config": {
            ...
            "cockpit": {
                "summary": {"active_review_workers": 10, "queued_jury_jobs": 0, "open_incidents": 0},
                "mission_board": {
                    "booster_runtime_card": {"active_onemin_codexers": 0, "active_boosters": 0},
                    "provider_credit_card": {
                        "slot_count_with_billing_snapshot": 74,
                        "slot_count_with_member_reconciliation": 74,
                        "hours_until_next_topup": 720,
                        "hours_remaining_at_current_pace_no_topup": 23.55,
                        "days_remaining_including_next_topup_at_7d_avg": 100,
                    },
                },
                "capacity_forecast": {
                    "lanes": [
                        {"lane": "core_booster", "ready_slots": 74, "configured_slots": 74, "degraded_slots": 0},
                        {"lane": "review_shard", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                    ]
                },
                "jury_telemetry": {"participant_burst": {"premium_queue_depth": 0}},
                "runway": {},
        ...
        self.assertEqual(payload["caps"]["credit_cap_until_next_topup"]["value"], 2)
        self.assertEqual(payload["effective_booster_cap"], 2)
        self.assertEqual(payload["limiting_cap"], "credit_cap_until_next_topup")
    ...
    def test_build_capacity_plan_does_not_fabricate_audit_capacity_from_zero_ready_slots(self) -> None:
        capacity_configs = {
            ...
            "audit_fabric": {"default": {"lane": "audit_shard", "service_floor": 10, "target_parallelism": 20}},
        }
        status = {
            "config": {
                "policies": {
            ...
            "cockpit": {
                "summary": {"active_review_workers": 10, "active_audit_workers": 0, "queued_jury_jobs": 0, "open_incidents": 0},
                "mission_board": {
                    "booster_runtime_card": {"active_onemin_codexers": 0, "active_boosters": 0},
                    "provider_credit_card": {
                        "slot_count_with_billing_snapshot": 20,
                ...
                "capacity_forecast": {
                    "lanes": [
                        {"lane": "core_booster", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                        {"lane": "review_shard", "ready_slots": 10, "configured_slots": 10, "degraded_slots": 0},
                        {"lane": "audit_shard", "ready_slots": 0, "configured_slots": 10, "degraded_slots": 0},
                    ]
                },
                "jury_telemetry": {"participant_burst": {"premium_queue_depth": 0}},
                "runway": {},
        ...
        self.assertEqual(payload["caps"]["audit_cap"]["value"], 0)
        self.assertEqual(payload["lane_targets"]["audit_shard"], 0)
        self.assertEqual(payload["effective_booster_cap"], 0)
        self.assertEqual(payload["limiting_cap"], "audit_cap")

    def test_build_capacity_plan_uses_spare_review_pre_audit_to_relieve_audit_cap(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
        ...
        status = {
            ...
            "work_packages": {
                "ready_booster_packages": 20,
                "ready_booster_scope_cap": 20,
                "scope_cap": 20,
                "active_booster_packages": 0,
            },
            "cockpit": {
                "summary": {"active_review_workers": 4, "active_audit_workers": 1, "queued_jury_jobs": 0, "open_incidents": 0},
                "mission_board": {
                    "booster_runtime_card": {"active_onemin_codexers": 0, "active_boosters": 0},
                    "provider_credit_card": {
                        "slot_count_with_billing_snapshot": 20,
                ...
                "capacity_forecast": {
                    "lanes": [
                        {"lane": "core_booster", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                        {"lane": "review_shard", "ready_slots": 4, "configured_slots": 4, "degraded_slots": 0},
                        {"lane": "audit_shard", "ready_slots": 1, "configured_slots": 1, "degraded_slots": 0},
                    ]
                },
                "jury_telemetry": {"participant_burst": {"premium_queue_depth": 0}},
                "runway": {},
        ...
        self.assertEqual(payload["inputs"]["pre_audit_equivalent_workers"], 1)
        self.assertEqual(payload["caps"]["audit_cap"]["value"], 2)
        self.assertEqual(payload["lane_targets"]["audit_shard"], 1)
        self.assertEqual(payload["effective_booster_cap"], 2)
        self.assertIn("pre_audit_relief_active", {item["type"] for item in payload["typed_findings"]})

    def test_build_capacity_plan_does_not_count_review_spare_as_pre_audit_without_deterministic_preflight(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
                "max_scale_up_per_tick": 2,
        ...
        self.assertFalse(payload["inputs"]["pre_audit_review_preflight_deterministic"])
        self.assertEqual(payload["inputs"]["pre_audit_equivalent_workers"], 0)
        self.assertEqual(payload["caps"]["audit_cap"]["value"], 1)
        self.assertNotIn("pre_audit_relief_active", {item["type"] for item in payload["typed_findings"]})

    def test_build_capacity_plan_pre_audit_does_not_replace_missing_audit_supply(self) -> None:
        capacity_configs = {
            "quartermaster": {"mode": "enforce"},
            "booster_pools": {
                "core_booster": {
        ...
        status = {
            ...
            "cockpit": {
                "summary": {"active_review_workers": 4, "active_audit_workers": 0, "queued_jury_jobs": 0, "open_incidents": 0},
                "mission_board": {
                    "booster_runtime_card": {"active_onemin_codexers": 0, "active_boosters": 0},
                    "provider_credit_card": {
                        "slot_count_with_billing_snapshot": 20,
                ...
                "capacity_forecast": {
                    "lanes": [
                        {"lane": "core_booster", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                        {"lane": "review_shard", "ready_slots": 4, "configured_slots": 4, "degraded_slots": 0},
                        {"lane": "audit_shard", "ready_slots": 0, "configured_slots": 0, "degraded_slots": 0},
                    ]
                },
                "jury_telemetry": {"participant_burst": {"premium_queue_depth": 0}},
                "runway": {},
    ...
    def test_build_capacity_plan_damps_booster_scale_up_to_ready_reserve_and_downstream_spare(self) -> None:
        capacity_configs = {
            "quartermaster": {
                "mode": "enforce",
                "max_scale_up_per_tick": 20,
                "max_scale_down_per_tick": 20,
                "ramp": {
                    "minimum_scale_up_step": 1,
                    "ready_reserve_step_divisor": 2,
                },
            },
            "booster_pools": {
                "core_booster": {
            ...
            "review_fabric": {"default": {"shards": {"lane": "review_shard", "service_floor": 1, "max_queue_depth_per_active_reviewer": 20}}},
            "audit_fabric": {"default": {"lane": "audit_shard", "service_floor": 1, "target_parallelism": 20}},
        }
        status = {
            "config": {
                "policies": {
            ...
            "cockpit": {
                "summary": {"active_review_workers": 20, "active_audit_workers": 20, "queued_jury_jobs": 0, "open_incidents": 0},
                "mission_board": {
                    "booster_runtime_card": {"active_onemin_codexers": 0, "active_boosters": 0},
                    "provider_credit_card": {
                        "slot_count_with_billing_snapshot": 20,
                ...
                "capacity_forecast": {
                    "lanes": [
                        {"lane": "core_booster", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                        {"lane": "review_shard", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                        {"lane": "audit_shard", "ready_slots": 20, "configured_slots": 20, "degraded_slots": 0},
                    ]
                },
                "jury_telemetry": {"participant_burst": {"premium_queue_depth": 20}},
                "runway": {},
            },
        }
        ...
        self.assertEqual(payload["effective_booster_cap"], 10)
        self.assertEqual(payload["lane_targets"]["core_booster"], 10)
        self.assertEqual(payload["ramp_damping"]["desired_core_booster_target"], 20)
        self.assertEqual(payload["ramp_damping"]["ramped_core_booster_target"], 10)
        self.assertEqual(payload["ramp_damping"]["booster_scale_up_budget"], 10)
        self.assertEqual(payload["limiting_cap"], "ramp_damping")

    def test_build_capacity_plan_ignores_stale_selected_core_lane_when_credit_burn_disabled(self) -> None:
        capacity_configs = {
            "quartermaster": {"mode": "enforce"},
            "booster_pools": {
                "core_booster": {
            ...
            "audit_fabric": {"default": {"lane": "audit_shard", "service_floor": 1, "target_parallelism": 4}},
        }
        status = {
            "config": {
                "policies": {
