...
wait_for_ui_refresh() {
  ...
  local baseline_executable_mtime="$3"
  local reuse_active_refresh="$4"
  local waited=0
  ...
  local current_executable_mtime
  ...
  current_executable_mtime="$(ui_receipt_mtime "$ui_executable_gate_path")"
  local current_flagship_status
  local current_visual_status
  local current_executable_status
...
baseline_ui_executable_mtime="$(ui_receipt_mtime "$ui_executable_gate_path")"
reused_active_refresh=0
