...
* scheduled public publication of the newest qualified Windows `win-x64` and Linux `linux-x64` desktop bundles into configured self-hosted downloads targets, with forced publication reserved for explicit release reasons
