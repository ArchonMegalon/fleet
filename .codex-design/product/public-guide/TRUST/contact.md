...
## Use public issue threads only when the report should be public

Most people should start with Help or Contact. A public issue thread is only for technical reports you want discussed in public.
