...
from test_materialize_next90_m139_fleet_operational_trust_closeout_gates import _fixture_tree


MATERIALIZER = Path("/docker/fleet/scripts/materialize_next90_m139_fleet_operational_trust_closeout_gates.py")
VERIFIER = Path("/docker/fleet/scripts/verify_next90_m139_fleet_operational_trust_closeout_gates.py")


class VerifyNext90M139FleetOperationalTrustCloseoutGatesTest(unittest.TestCase):
