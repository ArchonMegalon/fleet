...
try:
    from tests.test_materialize_next90_m136_fleet_derived_release_health_planes import _fixture_tree
except ModuleNotFoundError:
    from test_materialize_next90_m136_fleet_derived_release_health_planes import _fixture_tree


MATERIALIZER = Path("/docker/fleet/scripts/materialize_next90_m136_fleet_derived_release_health_planes.py")
VERIFIER = Path("/docker/fleet/scripts/verify_next90_m136_fleet_derived_release_health_planes.py")


class VerifyNext90M136FleetDerivedReleaseHealthPlanesTest(unittest.TestCase):
    ...
    def test_verifier_rejects_monitor_summary_drift(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            payload["monitor_summary"]["required_plane_count"] = 3
