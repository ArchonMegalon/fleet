...
FILENAME = "2026-03-18-chummer-live-public-surface-reaudit.md"
...
def main() -> None:
    write(FLEET_ROOT / "feedback" / FILENAME, CONTENT)
    write(GROUP_FEEDBACK_ROOT / FILENAME, CONTENT)
    print("Injected Chummer live public-surface re-audit into fleet and chummer-vnext feedback lanes.")
