(function () {
  ...
  function openProjectDrawer(project, groupId) {
    openDrawer("Project", project.id || "project", (body) => {
      ...
      const backendLine = activeBackend && activeBackend !== "not active"
        ? `${activeBackend}${activeIdentity ? ` (${activeIdentity})` : ""}`
        : "none";
      const brainLine = activeBrain && activeBrain !== "not active" ? activeBrain : "none";
