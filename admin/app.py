      ...
      <body>
        ...
        <div class="grid">
          <div class="panel">
            ...
            <p class="muted">idle projects: {html.escape(str(group.get('idle_project_count') or 0))} / auditor solve: {html.escape('yes' if group.get('auditor_can_solve') else 'no')}</p>
