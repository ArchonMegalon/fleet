...
9. `PUBLIC_AUTH_FLOW.md`
10. `IDENTITY_AND_CHANNEL_LINKING_MODEL.md`
11. `PUBLIC_MEDIA_BRIEFS.yaml`
12. `PARTICIPATION_AND_BOOSTER_WORKFLOW.md`
13. `COMMUNITY_SPONSORSHIP_BACKLOG.md`
14. `EXTERNAL_TOOLS_PLANE.md`
15. `LTD_CAPABILITY_MAP.md`
16. `PUBLIC_GUIDE_POLICY.md`
17. `PUBLIC_GUIDE_PAGE_REGISTRY.yaml`
18. `PUBLIC_PART_REGISTRY.yaml`
19. `PUBLIC_FAQ_REGISTRY.yaml`
20. `PUBLIC_HELP_COPY.md`
21. `PUBLIC_GUIDE_EXPORT_MANIFEST.yaml`
22. `HORIZON_SIGNAL_POLICY.md`
23. `PUBLIC_MEDIA_AND_GUIDE_ASSET_POLICY.md`
24. `OWNERSHIP_MATRIX.md`
25. `PROGRAM_MILESTONES.yaml`
26. `CONTRACT_SETS.yaml`
27. `GROUP_BLOCKERS.md`
28. `projects/*.md` for repo-specific scope
