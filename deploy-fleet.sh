...
copy_mutable_file "$BUNDLE_DIR/runtime.ea.env.example" "$INSTALL_DIR/runtime.ea.env"
copy_bundle_file "$BUNDLE_DIR/runtime.ea.env.example" "$INSTALL_DIR/runtime.ea.env.example"
