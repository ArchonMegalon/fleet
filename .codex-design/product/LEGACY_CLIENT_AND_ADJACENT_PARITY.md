...
| Legacy and adjacent import/oracle parity | Chummer4, Chummer5a, Hero Lab, Genesis/CommLink evidence | master-index now projects import-oracle fixture-family coverage, certification receipt posture, explicit adjacent SR6 oracle coverage posture (Genesis/CommLink), and bounded-loss import lane receipts for milestone-17 evidence; full first-class import UX closure remains open | partial | `17` |
